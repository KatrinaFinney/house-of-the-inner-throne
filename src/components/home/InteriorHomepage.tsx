...
export function InteriorHomepage() {
  return (
    <main className="relative min-h-screen overflow-hidden bg-[linear-gradient(180deg,#171510_0%,#0b0b09_38%,#060606_100%)] text-[var(--text)]">
      ...
      <div className="pointer-events-none absolute left-1/2 top-0 h-[42rem] w-px -translate-x-1/2 bg-[linear-gradient(180deg,rgba(202,169,107,0.22),transparent)]" />
        ...
        <div className="relative z-10 mx-auto grid w-full max-w-6xl gap-14 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          ...
          >
            ...
            <div className="mt-9 flex flex-col gap-4 sm:flex-row">
              <Link
                href="/archive"
                className="inline-flex min-w-[220px] items-center justify-center rounded-full border border-[var(--gold)] bg-[var(--gold)] px-7 py-3 text-[0.78rem] font-medium uppercase tracking-[0.16em] text-black shadow-[0_8px_30px_rgba(202,169,107,0.18)] transition hover:brightness-[1.04]"
              >
                Enter the Archive
              </Link>
              ...
              <Link
                href="/ritual-tools"
                className="inline-flex min-w-[220px] items-center justify-center rounded-full border border-[rgba(202,169,107,0.28)] bg-white/[0.03] px-7 py-3 text-[0.78rem] font-medium uppercase tracking-[0.16em] text-[var(--text)] transition hover:bg-white/[0.06]"
              >
                Enter the Chambers
              </Link>
            </div>
          ...
          <motion.div
            ...
            className="relative rounded-[2rem] border border-[rgba(202,169,107,0.12)] bg-[linear-gradient(180deg,rgba(255,255,255,0.05),rgba(255,255,255,0.025))] p-5 shadow-[0_24px_80px_rgba(0,0,0,0.35)] backdrop-blur-sm md:p-6"
          >
            ...
            <div className="relative">
              ...
              <div className="mt-5 space-y-4">
                {pillars.map((pillar) => (
                  ...
                  >
                    <p className="mb-2 text-[10px] uppercase tracking-[0.32em] text-[var(--gold)]/80">
                      Pillar
                    </p>
